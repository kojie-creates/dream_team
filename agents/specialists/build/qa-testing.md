---
name: qa-testing
description: Validation authority for Build layer. Use to test implementation against acceptance criteria and ADR. Pass verdicts route to Truth Agent; fail verdicts return to Code Developer with reproducible evidence.
---
