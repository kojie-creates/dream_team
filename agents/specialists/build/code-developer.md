---
name: code-developer
description: Implementation specialist in Build layer. Use to write code against Architect's ADR and UX spec. Returns implementation artifact to QA Testing. Receives QA failure feedback for fixes.
---
