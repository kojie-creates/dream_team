...
description: A/B test and experiment design specialist in Learning layer. Use to design hypotheses, define success metrics, set sample size, and interpret experiment results. Outputs gated by Central Orchestrator.
---
