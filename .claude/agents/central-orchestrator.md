...
description: Single authority for cross-layer routing, work queue ownership, and feedback control across the AI Ecosystem. Use to classify incoming work, route to layer coordinators, resolve escalations, and gate Learning outputs. Does not do specialist work.
---
