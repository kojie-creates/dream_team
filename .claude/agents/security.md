---
name: security
description: Security specialist in Operate layer. Use for threat modeling, vulnerability review, secret management, compliance posture, and incident response.
---
